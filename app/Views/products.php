...
<body>
    ...
    <form action="/save" method="post">
        ...
        <input type= "hidden" name="id" value="<php $pro['id']?>"> 
        <input type="text" name='name' value="<php $pro['name']?>">
        <br><br>
        <label>Product Description: </label>
        <input type="text" name='description' value="<php $pro['description']?>">
        <br><br>
        <label for="products">Choose a product category: </label>
        <select name="products" id="products" value="<php $pro['products']?>">
            <option value=""></option>
        ...
        <input type="number" name="quantity" id="" value="<php $pro['quantity']?>">
        <br><br>
        <label>Product Price: </label>
        <input type="number" name="price" id="" value="<php $pro['price']?>">
        <br><br>
